...
public final class CMPT456Analyzer extends StopwordAnalyzerBase {
   ...
   * begin: modify
   */
  /** Builds an analyzer with the customer stop words ({@link #STOP_WORDS_SET}).
   */
  public CMPT456Analyzer(String stopwordPath) throws IOException {
    this(new FileReader(stopwordPath));
  }
  ...
  protected TokenStreamComponents createComponents(final String fieldName) {
    ...
    /**
     * begin: add porter stemmer filter
     */
